    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title">
                <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Elegido Para Tí</h4>
            ...
            <div class="row">
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="/public/img/service-1.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                ...
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="/public/img/service-2.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                ...
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="/public/img/service-3.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                ...
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="/public/img/service-4.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
    ...
    <!-- Menu Start PONER LOS USUARIOS QUE HAYAN SUBIDO MÁS VÍDEOS O IMAGENES TODO-->
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title">
                <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Usuarios</h4>
                <h1 class="display-4">Usuarios Destacados</h1>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="/public/img/menu-1.jpg" alt="">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="/public/img/menu-2.jpg" alt="">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-4 col-sm-3">
                            <img class="w-100 rounded-circle mb-3 mb-sm-0" src="/public/img/menu-3.jpg" alt="">
    ...
    <!-- Reservation Start ¿PONER AQUÍ EL REGISTER? TODO -->
                            ...
                            <form class="mb-5">
                                ...
                                <div class="form-group">
                                    <div class="password" id="repeat-password" data-target-input="nearest">
                                        <input type="password" class="form-control bg-transparent border-primary p-4 datetimepicker-input" placeholder="Repite tu contraseña" data-target="#date" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                                <div>
